...
namespace bTools.TransformComponent
{
    public static class TransformTools
    {
        ...
        /// </summary>
        /// <aram name="target">The Transform to align to (Destination)</param>
        /// <param name="toAlign">The Transforms to align (Source)</param>
        ...
        /// <summary>
        /// Aligns toAlign Transforms to target Transform
        /// This operation is quite expensive as it needs to unparent and reparent GameObjects
        /// </summary>
        /// <aram name="target">The Transform to align to (Destination)</param>
        /// <param name="toAlign">The Transform to align (Source)</param>
        /// <param name="position">Set to true to align position</param>
		/// <param name="rotation">Set to true to align rotation</param>
		/// <param name="scale">Set to true to align scale</param>
        public static void AlignTransform(UnityEngine.Transform target, UnityEngine.Transform[] toAlign, bool position, bool rotation, bool scale)
        {
            bool[] options = new bool[] { false, false, false, false, false, false, false, false, false };
            if (position)
            {
                options[0] = true;
                options[1] = true;
            ...
            AlignTransform(target, toAlign, options);
        }
        ...
        /// <summary>
        /// Aligns toAlign Transform to target Transform
        /// This operation is quite expensive as it needs to unparent and reparent GameObjects
        /// </summary>
        /// <aram name="target">The Transform to align to (Destination)</param>
        /// <param name="toAlign">The Transform to align (Source)</param>
        ...
        /// <summary>
        /// Distributes Vector3's along the x axis between StartPosition and EndPosition
        /// </summary>
        /// <param name="startPosition">Start point of the distribution</param>
        /// <param name="endPosition">End point of the distribution</param>
        /// <param name="toDistribute">Array of Vector3 to distribute</param>
        public static void DistributeXPosition(Vector3 startPosition, Vector3 endPosition, Vector3[] toDistribute)
        {
            if (toDistribute.Length <= 0)
            {
                throw new System.Exception("toDistribute array is empty");
            ...
            for (int i = 0; i < toDistribute.Length; i++)
            {
                ...
                Vector3 cache = toDistribute[i];
                cache.x = startPosition.x;
                toDistribute[i] = cache;

                toDistribute[i] += currentPos;
            }
        }

        /// <summary>
        /// Distributes Vector3's along the y axis between StartPosition and EndPosition
        /// </summary>
        /// <param name="startPosition">Start point of the distribution</param>
        /// <param name="endPosition">End point of the distribution</param>
        /// <param name="toDistribute">Array of Vector3 to distribute</param>
        public static void DistributeYPosition(Vector3 startPosition, Vector3 endPosition, Vector3[] toDistribute)
        {
            if (toDistribute.Length <= 0)
            {
                throw new System.Exception("toDistribute array is empty");
        ...
        /// <summary>
        /// Distributes Vector3's along the z axis between StartPosition and EndPosition
        /// </summary>
        /// <param name="startPosition">Start point of the distribution</param>
        /// <param name="endPosition">End point of the distribution</param>
        /// <param name="toDistribute">Array of Vector3 to distribute</param>
        public static void DistributeZPosition(Vector3 startPosition, Vector3 endPosition, Vector3[] toDistribute)
        {
            if (toDistribute.Length <= 0)
            {
                throw new System.Exception("toDistribute array is empty");
        ...
        /// <summary>
        /// Distributes Vector3's between StartPosition and EndPosition
        /// </summary>
        /// <param name="startPosition">Start point of the distribution</param>
        /// <param name="endPosition">End point of the distribution</param>
        /// <param name="toDistribute">Array of Vector3 to distribute</param>
        public static void DistributePosition(Vector3 startPosition, Vector3 endPosition, Vector3[] toDistribute)
        {
            DistributeZPosition(startPosition, endPosition, toDistribute);
            DistributeYPosition(startPosition, endPosition, toDistribute);
            DistributeXPosition(startPosition, endPosition, toDistribute);
